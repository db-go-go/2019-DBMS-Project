                    ...
                    if(rightBro->nKeys-1 >= this->degree) {
                        ...
                        if(leftBro == NULL || leftBro->nKeys-1 < this->degree) {
                            if(parent->isRoot && parent->getChildNum() == 2) {
                                ...
                                cout << "mergeParentRight successfully\n";
                                ifDelete = false;
                                ifRemove = false;
                                managed = true;
                            }
...
void InnerNode::mergeParentRight(InnerNode* const& parent, InnerNode* const& rightBro) {
    ...
    cout <<"###InnerNode::mergeParentRight()\n";
    cout <<"rightBro:\t";rightBro->printNode();cout<<"\n";
    cout <<"parent:\t";parent->printNode();cout<<"\n";
    //cout << "parent->nChild="<<parent->nChild<<"\n";
    /*for (int i = 0;i < parent->nChild; i ++) {
        cout<<"parent->childrens["<<i<<"]:\t";
        parent->childrens[i]->printNode();
        cout<<"\n";
    }*/
    cout << "curret:\t";this->printNode();cout<<"\n";
    //delete this;
    cout << "parent->isRoot="<<parent->isRoot<<"\n";
    parent->isRoot = true;
}
...
void InnerNode::mergeRight(InnerNode* const& rightBro, const Key& k) {
    // TODO
    //cout << "###InnerNode::mergeRight() this->nKeys="<<this->nKeys<<"\n";
    //cout << "###InnerNode::mergeRight() this->nChild="<<this->nChild<<"\n";
    //cout << "###InnerNode::mergeRight() k="<<k<<"\n";
    //cout << "currentNode:\t";this->printNode();cout<<"\n";
